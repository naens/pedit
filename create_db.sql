...
(
	TextNodeFromID INTEGER NOT NULL,
	TextVersionFromID INTEGER NOT NULL,
	TextNodeToID INTEGER NOT NULL,
	TextVersionToID INTEGER NOT NULL,
	FOREIGN KEY (TextNodeFromID) REFERENCES TextNode (TextNodeID) ON DELETE CASCADE,
	FOREIGN KEY (TextVersionFromID) REFERENCES TextVersion (TextVersionID) ON DELETE CASCADE,
	FOREIGN KEY (TextNodeToID) REFERENCES TextNode (TextNodeID) ON DELETE CASCADE,
	FOREIGN KEY (TextVersionToID) REFERENCES TextVersion (TextVersionID) ON DELETE CASCADE
);
...
(
	...
	FOREIGN KEY (WordID) REFERENCES Word (WordID) ON DELETE CASCADE,
	FOREIGN KEY (LemmaID) REFERENCES LemmaValue (LemmaValueID) ON DELETE CASCADE
);
